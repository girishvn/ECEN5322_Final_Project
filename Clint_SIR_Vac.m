...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% - Clint_SIR_Vac.m: Runs the SIR model on a given adjacency matrix
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [numRecovered, infectedDistribution, susceptibleDistribution, recoveredDistribution] = Clint_SIR_Vac(A, Beta, mu, rand)
    ...
    numSusceptible = size(A,1) - 21;
    susceptible = ones(1,size(A,1));
    if(rand == "true")
        vaccinated = randperm(size(A,1), 20);
    else
        [v,index] = sort(degrees, 'descend');
        vaccinated = index(1:20);
    end
    susceptible(vaccinated) = 0;   
